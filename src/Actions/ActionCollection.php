...
class ActionCollection extends Collection
{
    public function listActions(): string
    {
        ...
        return $this->map(function (Action $action, $index) use ($width) {
    ...
    {
        return $this->filter(function (Action $action) use ($dev) {
            if (!$action instanceof ComposerRequire || $action->isInstalled()) {
                return false;
            }
    ...
    {
        return $this->filter(function (Action $action) {
            return !($action instanceof ComposerRequire);
        });
    }
    ...
    {
        return $this->first(function (Action $action) {
